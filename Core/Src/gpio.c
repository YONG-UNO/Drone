...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(IST831_RSTN_GPIO_Port, IST831_RSTN_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : IST831_RSTN_Pin */
  GPIO_InitStruct.Pin = IST831_RSTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(IST831_RSTN_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : INT1_ACCEL_Pin INT_ACCEL_Pin */
  GPIO_InitStruct.Pin = INT1_ACCEL_Pin|INT_ACCEL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
