...
// 示例:// 第一步：0~65535（16位）→ 0~8191（12位）
       // int p_int_12bit = uint_to_float(p_int, 0.0f, 8191.0f, 16);
       // 第二步：0~8191（12位）→ -12.57~12.57rad（实际位置）
       // float position = uint_to_float(p_int_12bit, P_MIN, P_MAX, 12);
